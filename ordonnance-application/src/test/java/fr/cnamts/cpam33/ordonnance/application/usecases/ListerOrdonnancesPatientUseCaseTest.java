...
class ListerOrdonnancesPatientUseCaseTest {

    private OrdonnanceRepository ordonnanceRepository;
    private ListerOrdonnancesPatientUseCase useCase;

    @BeforeEach
    void setUp() {
        ordonnanceRepository = mock(OrdonnanceRepository.class);
        useCase = new ListerOrdonnancesPatientUseCase(ordonnanceRepository);
    }
